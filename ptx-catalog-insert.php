...
<body>
  ...
  function stripslashes_safehtml($raw_text) {
...
*/
  ...
  $current_features_length = 13;
  $coauthors_count = $_POST['coauthors_count'];
//  echo $coauthors_count;
  ?>
  ...
  if ($_SESSION['whichpass'] == 0) {
    ...
    $display_project_subtitle = NULL;
    $display_project_subject_id = "1";
    $display_project_target_level_id = "1";
    $display_project_phase_id = "1";
    /* Features handled with old and new badges */
    $display_project_recognition_code = NULL;
    $display_project_award_id = NULL;
    $display_project_license_code = "1";
    $display_project_license_variant = NULL;
    $display_project_license_version = NULL;
    $display_project_publication_year = date("Y");
    $display_project_price_amount = NULL;
    $display_project_price_currency = NULL;

    $display_project_description_onesentence = "";
    $display_project_description_full = "";

    $display_project_landing_URL = NULL;
    $display_project_source_URL = NULL;
    $display_project_html_URL = NULL;
    $display_project_pdf_URL = NULL;
    $display_project_print_URL = NULL;
    $display_project_ancillary_1 = NULL;
    $display_project_ancillary_2 = NULL;
//    $projectbadges = $project['project_features'];
// $projectbadges is a string of 0s and 1s
    for ($i=1; $i <= $current_features_length; $i++) {
      $oldbadges[$i] = 0;
      $newbadges[$i] = 0;
    }
  ...
  $oldbadges = array_fill(1,$current_features_length,0);
...
<div class="header">
  <h2>PreTeXt Catalog New Project Page</h2>
...
//  $outstr = "Which pass is: ".$whichpass." <br>";
  ...
  if ($current_features_length %4 != 0){
    $outstr .= "      </tr><br><br>\n";
  }
  $outstr .= "     </table><br><br>\n\n";
  ...
  $outstr .= "     <input type=\"number\" name=\"project_price_amount\"  min=\"0\" max=\"999.99\" step=\".01\" value=\"" . $display_project_price_amount . "\" placeholder=\"nnn.nn\" size=\"20\">\n\n";
  ...
  /* Project Description */
  $safedesc = safehtml($display_project_description_onesentence) ;
  ...
  $safedesc = safehtml($display_project_description_full);
  $outstr .= "     <label>Project Desription Full (HTML encouraged)".$reqd.": &nbsp;</label>\n";
  ...
  for ($cid =1; $cid <= $coauthors_count; $cid ++) {
//    $outstr .= "     <input type=\"hidden\" name=\"coauthors_id\" value=\"". $cid. "\">\n\n";

    if ($_SESSION['whichpass'] == 0){
      $display_coauthors_name = "";
      $display_coauthors_url = "";
      $display_coauthors_email = "";
      $display_coauthors_affiliation = "";
      $display_coauthors_affiliation_2 = "";
    }
    else{
  ...
  $outstr .= "    <input type=\"hidden\" name=\"coauthors_count\" value=\"".$coauthors_count."\" >\n";
  ...
  $sqlstr = "INSERT INTO projects SET \n";

  $sqlstr .= "project_xml_id = '". $xml_id . "',\n";
  ...
  $sqlstr .= "project_publication_year = '" . $_POST['project_publication_year'] . "', \n";
...
/*  $sqlstr .= "(project_xml_id, project_title, project_subtitle, project_subject_id, project_target_level_id, project_phase_id, \n";
  $sqlstr .= "project_features, project_recognition_code, project_award_id, project_license_code, project_license_variant, \n";
  $sqlstr .= "project_license_version, project_publication_year, project_price_amount, project_price_currency, project_description_onesentence, \n";
  $sqlstr .= "project_description_full, project_landing_URL, project_source_URL, project_html_URL, project_pdf_URL, project_print_URL) \n";
  $sqlstr .= "VALUES ('$xml_id', '".'$_POST['project_title']."', '".'$_POST['project_subtitle']."', '".'$_POST['project_subject_id']."', '".'$_POST['project_target_level_id']."', \n";
  $sqlstr .= "$_POST['project_phase_id'], $new_project_features, $recognition_code, $_POST['project_award_id'], $_POST['project_license_code'], \n";
  $sqlstr .= "$_POST['project_license_variant'], $_POST['project_license_version'], $_POST['project_publication_year'], $price_amount, \n";
  $sqlstr .= "$_POST['project_price_currency'], $_POST['project_description_onesentence'], $_POST['project_description_full'], $_POST['project_landing_URL'], \n";
  $sqlstr .= "$_POST['project_source_URL'], $_POST['project_html_URL'], $_POST['project_pdf_URL'], $_POST['project_print_URL']); \n\n";
*/
//$sqlstr .= "(project_xml_id, project_title) VALUES ('$xml_id', '".'$_POST['project_title']."');\n";



for ($cid=1; $cid <= $coauthors_count; $cid ++){
    $sqlstr .= "INSERT INTO coauthors SET \n";
    $sqlstr .= "coauthors_project_id = '" . $xml_id . "', \n";
